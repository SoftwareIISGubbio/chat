 ...
 * Usa una classe "ascoltatore" separata, pare più cpmplicato che altro
 ***************************************************************************/
public class EchoClient2 extends Application{
	
	private class Ascoltatore implements WebSocket.Listener{
		@Override
	...
	public void start(Stage finestra) throws Exception {
		...
		URI uri = URI.create("ws://localhost:7000/ws/echo");
		Listener listener = new Ascoltatore();
